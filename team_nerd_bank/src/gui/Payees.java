...
public class Payees extends JPanel{
	...
	public Payees() {
		...
		lblInfo = new JLabel("<html>Please fill required details.  Please be aware that the details will be confirmed within <u>seven</u> days .</html>");
		...
		label = new JLabel("<html>Please fill required details.  Please be aware that the details will be confirmed within <u>seven</u> days .</html>");
